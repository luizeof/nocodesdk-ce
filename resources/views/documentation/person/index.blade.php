<x-documentation-layout>
    ...
    <div class="px-6 py-16 mx-auto max-w-7xl sm:py-24 lg:px-8">
        <div class="grid flex-wrap gap-8 sm:grid-cols-3">
            ...
            <a href="{{ route('documentation.show', ['person', 'name']) }}" class="block p-6 bg-white border border-gray-200 rounded-lg">
                <div
                ...
                <h2 class="mb-2 text-lg font-medium text-gray-900 title-font">Name</h2>
