    ...
    <div class="bg-white">
            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="{{ route('documentation.show', ['email','index']) }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">E-mail</a>
                </div>
              </li>
            </ol>
          </nav>
        <div class="px-6 py-16 mx-auto max-w-7xl sm:py-24 lg:px-8">
            <div class="text-center">
                <p class="text-lg font-semibold text-indigo-600">E-mail API</p>
                ...
                <dl class="divide-y divide-gray-200">
                    <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                        ...
                        <dd class="flex mt-1 text-base text-gray-900 sm:col-span-2 sm:mt-0">
                            <span class="flex-grow font-mono">{{ env('APP_URL') }}/api/v1/email/basic-validation</span>
                        </dd>
                    </div>
                    <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
